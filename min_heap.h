// This code copy from https://github.com/BigWheel92/Min-Heap
...
class MinHeap {
  // each item in heap will be HeapItem (a <key, value> pair). Both key and value can be of the same datatype or
  // different data type.
  // Key and value can be of a user-defined class as well. If key is of non-primitive datatype, then the > and <
